...
// Date: 3 January 2023
// Description:  This is the spec.ts file for the app component.
...
describe('AppComponent', () => {
  ...
  it(`should have as title 'hello-world'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.myWorld).toEqual('hello-world');     //1/3/2023: modified app.title to app.myWorld to resolve error.
  });
